...
RUN apk add --no-cache -t .build ruby-dev build-base g++ openssl-dev pcre-dev zlib-dev curl git \
...
CMD ["/usr/local/bin/start-s3-proxy.sh", "jeordy-test-bucket", "us-east-2"]
